...
export default {
    ...
    data() {
        return {
            projects: [
                { id: 1, name: 'Lunetterie de Villeroy', description: 'Description du projet 1', url: 'https://mmi21b07.mmi-troyes.fr/ws501/', image: '../public/lunetterie.jpg' },
                { id: 2, name: 'Projet 2', description: 'Description du projet 2', url: '/projet2', image: 'path/to/image2.jpg' },
                { id: 3, name: 'Projet 3', description: 'Description du projet 3', url: '/projet3', image: 'path/to/image3.jpg' }
            ]
        };
    },
    methods: {
